...
@section('content')
    ...
    <div class='panel panel-default'>
        ...
        <div class='panel-body'>
            <form method='post' action='{{ url('admin/laporan/harian') }}'>
                @csrf
                <div class="row">
            ...
            <div class='panel-heading'>
                <div class="row">
                    ...
                    <div class="col-lg-6 text-right">
                        <a href="/admin/laporan/harian/export/{{ $periode_awal }}/{{ $periode_akhir }}/{{ $status }}/{{ $layanan }}"
            ...
            <div class='panel-body'>
                <table class="table table-striped" id="datatab">
                    <tr style="text-center">
                        ...
                        <th style="font:bold;font-size: 18px">Layanan</th>
                        <th style="font:bold;font-size: 18px">Nama</th>
                        <th style="font:bold;font-size: 18px">Cost Center</th>
                        <th style="font:bold;font-size: 18px">Telepon</th>
                        <th style="font:bold;font-size: 18px">Produk</th>
                        <th style="font:bold;font-size: 18px">Harga</th>
                        <th style="font:bold;font-size: 18px">Lunas</th>
                        <th style="font:bold;font-size: 18px">Tanggal</th>
