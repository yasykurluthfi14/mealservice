...
class AdminProduksController extends \crocodicstudio\crudbooster\controllers\CBController
{
	...
	public function cbInit()
	{
		...
		//$this->form[] = ["label"=>"Uom","name"=>"uom","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
		...
		// // filter aktif
		$this->index_button[] = ['label' => 'Aktif', 'url' => CRUDBooster::mainpath('?filter_column[produk_work_orders.kategori][type]=&filter_column[produk_work_orders.kategori][sorting]=&filter_column[produk_work_orders.deskripsi][type]=&filter_column[produk_work_orders.deskripsi][sorting]=&filter_column[produk_work_orders.satuan][type]=&filter_column[produk_work_orders.satuan][sorting]=&filter_column[produk_work_orders.keterangan][type]=&filter_column[produk_work_orders.keterangan][sorting]=&filter_column[produk_work_orders.status][type]=%3D&filter_column[produk_work_orders.status][value]=1&filter_column[produk_work_orders.status][sorting]=&lasturl=https%3A%2F%2Fdev.assetmanagementz4.id%2Fadmin%2Fproduks'), 'icon' => 'fa fa-check'];
		$this->index_button[] = ['label' => 'Tidak Aktif', 'url' => CRUDBooster::mainpath('?filter_column[produk_work_orders.kategori][type]=&filter_column[produk_work_orders.kategori][sorting]=&filter_column[produk_work_orders.deskripsi][type]=&filter_column[produk_work_orders.deskripsi][sorting]=&filter_column[produk_work_orders.satuan][type]=&filter_column[produk_work_orders.satuan][sorting]=&filter_column[produk_work_orders.keterangan][type]=&filter_column[produk_work_orders.keterangan][sorting]=&filter_column[produk_work_orders.status][type]=like&filter_column[produk_work_orders.status][value]=0&filter_column[produk_work_orders.status][sorting]=&lasturl=https%3A%2F%2Fdev.assetmanagementz4.id%2Fadmin%2Fproduks'), 'icon' => 'fa fa-remove'];
