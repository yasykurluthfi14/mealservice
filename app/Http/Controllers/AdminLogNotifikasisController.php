<?php namespace App\Http\Controllers;
	...
	class AdminLogNotifikasisController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"File Url","name"=>"file_url"];
			$this->col[] = ["label"=>"Report","name"=>"report"];
			...
			$this->form[] = ['label'=>'File Url','name'=>'file_url','type'=>'upload','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"File Url","name"=>"file_url","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Report","name"=>"report","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Report File","name"=>"report_file","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Resend","name"=>"resend","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			# OLD END FORM
